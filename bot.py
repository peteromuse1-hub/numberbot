...
async def button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Wipe the buttons off whatever menu the user just tapped so it doesn't
    # linger in the chat — the bot's new reply appears below a clean message.
    try:
        await query.edit_message_reply_markup(reply_markup=None)
    except Exception:
        # Message may be too old to edit, or already had no keyboard — fine either way.
        pass
